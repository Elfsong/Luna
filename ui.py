...
st.markdown('#### Step 1. Resouece Initialization')
...
with st.spinner('Loading Case Notes...'):
    if not st.session_state.casenotes:
        time.sleep(2)
        ...
        # new_option_list = st.multiselect('Which Case Note Field you would like to involve in the inference?', option_list, option_list)
...
st.markdown('#### Step 3. Product Name Inference')
